function onCreate()
	...
	makeLuaSprite('bars', 'bars', -600, -360)
	setObjectCamera('bars', 'hud')
	scaleObject('bars', 0.3, 0.3)
	...
	makeAnimatedLuaSprite('stage', 'stage', -520, 0)
	luaSpriteAddAnimationByPrefix('stage', 'stage', 'stage', 14, true);
	objectPlayAnimation('stage','stage',false)
...
function onBeatHit()
	if songName == 'war-cry-revamp' then
		if curBeat == 64 then
       
			removeLuaSprite('megamanstage',false);
			...
			function onUpdate()
				...
				if followchars == true then
					...
					function onUpdate()
if songName == 'reploid-rock-revamp' then
